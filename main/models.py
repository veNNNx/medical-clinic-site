...
class Visit(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='visit_user')

    def __str__(self):
        return str(self.doctor.first_name) + ' ' + str(self.doctor.last_name) + ' ' + str(self.user.first_name) + ' ' + str(self.user.last_name) + ' ' + str(self.date) + ' ' + str(self.time)
...
class Profile(models.Model):
    ...
    img = models.ImageField(upload_to='images/',
                            default='images/default_picture.jpg')
    # if not
